...
<body>
    ...
    <main>
        ...
        <div class="image1">
            ...
            <img class="image1" src= "../images/image 1 profil.png" alt="">
            
            <h3>Qu'est ce que l'huile de CBD :</h3>      

            <p class="text">
                L'huile de CBD est devenue de plus en plus populaire ces dernières années en raison de ses nombreux
                bienfaits potentiels pour la santé. Le CBD, ou cannabidiol, est l'un des nombreux composés naturels
                présents dans la plante de cannabis.
            </p>
